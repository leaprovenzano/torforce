...
# -*- coding: utf-8 -*-
#
# torforce documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'torforce.tex',
     u'Torforce Documentation',
